...
?>
    ...
    <footer id="footer">
      ...
      <div class="footer-widgets-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4  col-sm-6 col-6 dt-sc-one-fourth ">
                <aside id="text-2" class="widget widget_text">
                  <h3 class="widgettitle">Liên hệ</h3>
                    <ul>
                      <li><strong>Địa chỉ:</strong> 553-555 Lê Hồng Phong, P1, Q10, TPHCM</li>
                      <li><strong>Điện thoại:</strong> (028) 38 397 066</li>
                      <li><strong>Hotline:</strong> 0967 18 63 67</li>
                    </ul>
                </aside>
              </div>
              ...
              <div class="col-lg-3 col-md-4  col-sm-6 col-6 dt-sc-one-fourth ">
                <aside id="text-4" class="widget widget_text">
                  <h3 class="widgettitle">Vị trí</h3>
                  <div class="textwidget">
                    <figure><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.559285992649!2d106.67180561431012!3d10.76840889232698!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ee07a163fc1%3A0xffcbbacd8220af2e!2zNTU1IEzDqiBI4buTbmcgUGhvbmcsIFBoxrDhu51uZyAxMCwgUXXhuq1uIDEwLCBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1554344379552!5m2!1svi!2s" allowfullscreen="" width="100%" height="200"></iframe></figure>
                  </div>
                </aside>
              </div>
        ...
        <div class="copyright">
          <div class="container">
            <div class="copyright-content">Dev © 2019. Design by SpringDev</div>
          </div>
        </div>
    </footer>
  </div>
